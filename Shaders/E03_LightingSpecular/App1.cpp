...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in)
{
	...
	light->SetDirection(1.0f, -5.0f, 0.0f);
...
bool App1::Render()
{
	...
	XMFLOAT3 cam_pos = m_Camera->GetPosition();
	...
	shader->SetShaderParameters(m_Direct3D->GetDeviceContext(), worldMatrix, viewMatrix, projectionMatrix, m_Mesh->GetTexture(), light, cam_pos);
