...
BlurShader::BlurShader(ID3D11Device* device, HWND hwnd, WCHAR* vs_filename, WCHAR* ps_filename) : BaseShader(device, hwnd)
{
...
void BlurShader::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{
