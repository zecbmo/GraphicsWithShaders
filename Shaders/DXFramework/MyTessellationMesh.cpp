...
MyTessellationMesh::~MyTessellationMesh()
{
	// Run parent deconstructor
	BaseMesh::~BaseMesh();
}

void MyTessellationMesh::SendData(ID3D11DeviceContext *deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
void MyTessellationMesh::InitBuffers(ID3D11Device* device)
{
	VertexType* vertices;
