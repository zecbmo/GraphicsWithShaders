...
SpherePointMesh::SpherePointMesh(ID3D11Device * device, ID3D11DeviceContext * deviceContext, WCHAR * textureFilename, int resolution)
{
...
SpherePointMesh::~SpherePointMesh()
{
...
void SpherePointMesh::InitBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void SpherePointMesh::SendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
