...
bool App1::Render()
{
	...
	//// Set shader parameters (matrices and texture)
	shader->SetShaderParameters(m_Direct3D->GetDeviceContext(), worldMatrix, viewMatrix, projectionMatrix, m_quad->GetTexture(), light, light2);
	//// Render object (combination of mesh geometry and shader process
