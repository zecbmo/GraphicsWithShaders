...
void App::RenderDissolve()
{
	...
	text_shader->SetShaderParameters(m_Direct3D->GetDeviceContext(), worldMatrix, viewMatrix, projectionMatrix, m_Mesh->GetTexture());

	//// Render object (combination of mesh geometry and shader process
	text_shader->Render(m_Direct3D->GetDeviceContext(), m_Mesh->GetIndexCount());
